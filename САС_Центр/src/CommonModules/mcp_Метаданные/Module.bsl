...
Функция ОписаниеСтруктурыОбъектаМетаданныхКлиента(ИдКлиента, Конфигурация) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ДанныеОбъектовСопровождения.ИдКлиента КАК ИдКлиента,
	|	ДанныеОбъектовСопровождения.ИмяФайла КАК ИмяФайла,
	|	ДанныеОбъектовСопровождения.РазмерФайла КАК РазмерФайла,
	|	ДанныеОбъектовСопровождения.Файл КАК Файл,
	|	ДанныеОбъектовСопровождения.Конфигурация КАК Конфигурация
	|ИЗ
	|	РегистрСведений.ДанныеОбъектовСопровождения КАК ДанныеОбъектовСопровождения
	|ГДЕ
	|	ДанныеОбъектовСопровождения.ИдКлиента = &ИдКлиента
	|	И ДанныеОбъектовСопровождения.Конфигурация = &Конфигурация";
	...
	Если Не РезультатЗапроса.Пустой() Тогда 
		...
		ДвоичныеДанные = Выборка.Файл.Получить();
